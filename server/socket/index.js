module.exports = io => {
  io.on('connection', socket => {
    ...
    socket.on('newMessage', (message) => {
      socket.to(message.user.challenger.name + message.user.name).emit('newMessage', message);
      socket.to(message.user.name + message.user.challenger.name).emit('newMessage', message);
    })
